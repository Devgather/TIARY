...
@DisplayName("[AuthenticationExceptionHandler] createAccessTokenCookie")
class CreateAccessTokenCookieTest {
    ...
    void beforeEach() throws Exception {
        ...
        createAccessTokenCookieMethod = authenticationExceptionHandler.getClass().getDeclaredMethod(
    ...
    void successIfAccessTokenCookieIsCreated() throws Exception {
        ...
        // When
        final Cookie result = (Cookie) createAccessTokenCookieMethod.invoke(authenticationExceptionHandler, payload);
