...
class WriteTilTest {
    ...
    void failIfProfileUuidDoesNotExist() {
        // Given
        ...
        assertThat(result.getStatus()).isEqualTo(TilStatus.NOT_EXISTING_PROFILE_UUID);
    }
    ...
    void successIfTilIsAcceptable() {
        ...
        doReturn(TilTagFactory.create(til, tag))
                .when(tilTagRepository)
                .save(any(TilTag.class));
