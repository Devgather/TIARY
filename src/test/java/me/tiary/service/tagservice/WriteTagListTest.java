...
@ServiceTest
@DisplayName("[TagService] writeTagList")
class WriteTagListTest {
    ...
    void failIfTilDoesNotExist() {
        ...
        // When, Then
        final TagException result = assertThrows(TagException.class, () -> tagService.writeTagList(profileUuid, tilUuid, requestDto));
    ...
    void successIfTagsAreAcceptable() {
        ...
        // When, Then
        assertDoesNotThrow(() -> tagService.writeTagList(profileUuid, tilUuid, requestDto));
    }
}