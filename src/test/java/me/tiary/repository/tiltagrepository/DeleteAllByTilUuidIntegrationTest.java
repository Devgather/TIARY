...
@DisplayName("[TilTagRepository - Integration] deleteAllByTilUuid")
class DeleteAllByTilUuidIntegrationTest {
    @Autowired
    ...
    @Test
    @DisplayName("[Success] til tags are deleted")
    void successIfTilTagsAreDeleted() {
        // Given
        ...
        // When
        tilTagRepository.deleteAllByTilUuid(til.getUuid());
