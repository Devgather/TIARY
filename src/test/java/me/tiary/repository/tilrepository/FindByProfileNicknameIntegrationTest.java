...
@DisplayName("[TilRepository - Integration] findByProfileNickname")
class FindByProfileNicknameIntegrationTest {
    @Autowired
    ...
    void successIfTilNumberDoesMeetRequest() {
        ...
        // When
        final Page<Til> result1 = tilRepository.findByProfileNickname(profile.getNickname(), pageable1);
        final Page<Til> result2 = tilRepository.findByProfileNickname(profile.getNickname(), pageable2);
        final Page<Til> result3 = tilRepository.findByProfileNickname(profile.getNickname(), pageable3);
