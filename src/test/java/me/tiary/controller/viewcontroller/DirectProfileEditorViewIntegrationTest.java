...
@DisplayName("[ViewController - Integration] directProfileEditorView")
class DirectProfileEditorViewIntegrationTest {
    @Autowired
    ...
    void successIfProfileEditorViewIsRendered() throws Exception {
        // Given
